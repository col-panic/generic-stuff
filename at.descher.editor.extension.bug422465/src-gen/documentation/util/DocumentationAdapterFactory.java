...
public class DocumentationAdapterFactory extends AdapterFactoryImpl {
	...
	protected DocumentationSwitch<Adapter> modelSwitch =
		new DocumentationSwitch<Adapter>() {
			@Override
			public Adapter caseApplicationElementDocumentation(ApplicationElementDocumentation object) {
				return createApplicationElementDocumentationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link documentation.ApplicationElementDocumentation <em>Application Element Documentation</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createApplicationElementDocumentationAdapter() {
		return null;
	}
