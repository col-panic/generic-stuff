...
public class DocumentationFactoryImpl extends EFactoryImpl implements DocumentationFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DocumentationPackage.APPLICATION_ELEMENT_DOCUMENTATION: return createApplicationElementDocumentation();
			default:
	 ...
	 * @generated
	 */
	public ApplicationElementDocumentation createApplicationElementDocumentation() {
		ApplicationElementDocumentationImpl applicationElementDocumentation = new ApplicationElementDocumentationImpl();
		return applicationElementDocumentation;
	}
